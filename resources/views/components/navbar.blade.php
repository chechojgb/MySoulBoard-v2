           ...
           <ul class="space-y-2">
               <li>
                   <a href="{{route('dashboard.admin')}}" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                       ...
                       <span class="ml-3" :class="sidebarOpen ? 'opacity-100 ml-3' : 'opacity-0 w-0 overflow-hidden'">Overview</span>
                   </a>
               </li>
               <li>
                   <button type="button" class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
                       ...
                       <span class="flex-1 ml-3 text-left whitespace-nowrap" :class="sidebarOpen ? 'opacity-100 ml-3' : 'opacity-0 w-0 overflow-hidden'">Pages</span>
               ...
               <li>
                   <a href="#" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                       ...
                       <span class="flex-1 ml-3 whitespace-nowrap" :class="sidebarOpen ? 'opacity-100 ml-3' : 'opacity-0 w-0 overflow-hidden'">Messages</span>
                       <span class="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-primary-800 bg-primary-100 dark:bg-primary-200 dark:text-primary-800" :class="sidebarOpen ? 'opacity-100 ml-3' : 'opacity-0 w-0 overflow-hidden'">
                           6   
                       </span>
                   </a>
               </li>
